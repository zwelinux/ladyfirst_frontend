  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(251,146,60,0.12),_transparent_34%),radial-gradient(circle_at_top_right,_rgba(15,23,42,0.08),_transparent_28%),linear-gradient(180deg,_#fcfcfb_0%,_#f1f5f9_100%)] text-slate-900">
      <div className="mx-auto max-w-7xl px-5 py-8 lg:px-8">
        <header className="relative overflow-hidden rounded-[34px] border border-slate-200/80 bg-[linear-gradient(135deg,_#0f172a_0%,_#111827_55%,_#1e293b_100%)] text-white shadow-[0_24px_80px_rgba(15,23,42,0.24)]">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(251,146,60,0.18),_transparent_32%),radial-gradient(circle_at_85%_18%,_rgba(255,255,255,0.08),_transparent_24%)]" />
          ...
          <div className="relative grid gap-8 px-6 py-7 lg:grid-cols-[1.25fr_0.75fr] lg:px-8 lg:py-8">
            <div className="flex flex-col justify-between">
              <div>
                <div className="flex flex-wrap items-center gap-3 text-xs font-medium uppercase tracking-[0.24em] text-slate-300">
                  <span className="inline-flex items-center rounded-full border border-white/10 bg-white/6 px-3 py-1.5 backdrop-blur-sm">
                    Lady First Admin
                  </span>
                ...
                <div className="mt-8 max-w-3xl">
                  ...
                  <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
                    One operational surface for commerce, payments, order review, and internal workflows.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                {[
                  ...
                  <span
                    key={item}
                    className="inline-flex items-center rounded-full border border-white/10 bg-white/6 px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-200 backdrop-blur-sm"
                  >
                    {item}
                  </span>
                ))}
            ...
            <div className="flex flex-col justify-between gap-4">
              <div className="rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,_rgba(255,255,255,0.09)_0%,_rgba(255,255,255,0.04)_100%)] p-5 backdrop-blur-sm shadow-[0_18px_40px_rgba(15,23,42,0.18)]">
                <div className="flex items-center justify-between gap-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-400">
                    Session
                  </p>
                  <span className="inline-flex items-center rounded-full border border-white/10 bg-black/10 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-200">
                    Active
                  </span>
                </div>

                <div className="mt-5 flex items-start gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(135deg,_#f97316_0%,_#fb923c_100%)] text-base font-semibold text-white shadow-[0_10px_24px_rgba(249,115,22,0.4)]">
                ...
                <div className="mt-5 flex justify-end">
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-full border border-white/12 bg-white/6 px-3.5 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-white transition hover:border-white/20 hover:bg-white/10"
                  >
                    Logout
                  </button>
                </div>
